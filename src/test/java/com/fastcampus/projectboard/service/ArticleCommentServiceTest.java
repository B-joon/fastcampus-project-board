...
import com.fastcampus.projectboard.reopsitory.ArticleCommentRepository;
...
class ArticleCommentServiceTest {
    ...
    void givenArticleCommentInfo_whenSavingArticleComments_thenSavesArticleComments() {
        ...
        // when
        sut.saveArticleComment(ArticleCommentDto.of(LocalDateTime.now(), "Bong", LocalDateTime.now(), "Bong", "Comment"));
